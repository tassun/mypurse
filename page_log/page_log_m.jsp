...
<link rel="stylesheet" type="text/css" href="page_log/page_log.css?<%=System.currentTimeMillis()%>" />
<script  type="text/javascript" src="page_log/page_log.js?<%=System.currentTimeMillis()%>"></script>

<div id="page_log" class="pt-page pt-page-item">
		<div id="ptsearchpager" class="pt-page pt-page-current pt-page-controller search-pager">
			<div id="searchpanel" class="panel-body">
						...
						<div class="col-md-12" style="padding-left: 0px; padding-right: 0px;">
							<div class="col-md-2 col-height search-group">
								...
								<div class="input-group">
									<input type="text" id="fromdates" name="fromdate" class="form-control input-md" picture="99/99/9999" value="${fsJIOBean.fromdate}"/>
							...
							<div class="col-md-2 col-height search-group">
								...
								<div class="input-group">
									<input type="text" id="todates" name="todate" class="form-control input-md" picture="99/99/9999" value="${fsJIOBean.todate}"/>
				...
				<div id="listpanel" class="table-responsive" style="padding-top: 20px;">
					<jsp:include page="page_log_d.jsp"/>
				</div>
