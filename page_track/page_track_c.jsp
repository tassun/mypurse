...
<jsp:useBean id="fsTULBean" scope="request" class="com.fs.bean.TULBean"/>
...
<%
session.setAttribute("fsTULBean",fsTULBean);
...
System.out.println("page_track_c.jsp > "+fs_forwarder);
