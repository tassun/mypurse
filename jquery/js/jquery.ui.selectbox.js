...
$.widget( "ui.selectbox", {
			...
			_create: function() {
				...
				var button = this.button = $('<button type="button"  ID="LK'+eid+'"  align="absmiddle" class="jrivaly lookup-select-button-class">&nbsp;</button>')
					.mouseover(function(){ $(this).addClass('lookup-select-button-class-hover');}).mouseout(function(){$(this).removeClass("lookup-select-button-class-hover");})
					.bind("ondeactivate",function() { fs_rival_deactivate(eid,this);}).bind("onbeforedeactivate",function(){ fs_rival_beforedeactivate(eid,this);})
					.attr( "tabIndex", -1 )
