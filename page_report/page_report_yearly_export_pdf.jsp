...
try {
	...
	fs_writer.addHeader("yearly",fsLabel.getText("yearly_column","Year")).setAlignment("center");
	...
	fs_writer.addonHeader(new TbField(0,fsLabel.getText("asat_column","As At")+" : "+fsTRXMYearlyBean.getFromdate()+" - "+fsTRXMYearlyBean.getTodate()));
