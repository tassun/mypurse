...
<jsp:useBean id="fsTRXMMonthlyBean" scope="request" class="com.fs.bean.TRXMReportBean"/>
<jsp:setProperty name="fsTRXMMonthlyBean" property="*"/>
<c:if test="${fsScreen.init('page_report',pageContext.request, pageContext.response,true)}"></c:if>
<%
session.setAttribute("fsTRXMMonthlyBean",fsTRXMMonthlyBean);
...
System.out.println("page_report_monthly_c.jsp > "+fs_forwarder);
