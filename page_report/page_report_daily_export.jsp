...
String fs_forwarder = "/page_report/page_report_daily_export_excel.jsp";
String fs_reporttype = request.getParameter("reporttype");
if("pdf".equalsIgnoreCase(fs_reporttype)) fs_forwarder = "/page_report/page_report_daily_export_pdf.jsp";
System.out.println("page_report_daily_export.jsp > "+fs_forwarder);
try { 
	...
	if(fsTUserReportBean.getUserid()==null || fsTUserReportBean.getUserid().trim().length()<=0) {
		fsTUserReportBean.setUserid(fsTRXMDailyBean.getUserid());
	}
