...
try {
	...
	fs_writer.addHeader("cdrefdate",fsLabel.getText("cdrefdate_column","Date"));
	...
	fs_writer.addonRowHeader(new TbField(0,fsLabel.getText("asat_column","As At")+" : "+fsTRXMDailyBean.getFromdate()+" - "+fsTRXMDailyBean.getTodate()));
