...
<jsp:useBean id="fsTRXMYearlyBean" scope="request" class="com.fs.bean.TRXMReportBean"/>
<jsp:setProperty name="fsTRXMYearlyBean" property="*"/>
<c:if test="${fsScreen.init('page_report',pageContext.request, pageContext.response,true)}"></c:if>
<%
session.setAttribute("fsTRXMYearlyBean",fsTRXMYearlyBean);
...
System.out.println("page_report_yearly_c.jsp > "+fs_forwarder);
