...
<jsp:useBean id="fsCreditBean" scope="request" class="com.fs.bean.CreditBean"/>
<jsp:setProperty name="fsCreditBean" property="*"/>
<%
//#import and uses wherever you will go
//#(10000) programmer code begin;
System.out.println(">>>>>> request : "+request);
System.out.println("======== parameters in tso001_c.jsp =========");
...
String fs_forwarder = "/tso001/tso001_cd.jsp";
try {
	...
	if(map!=null) {
		fsGlobal.obtain(map);
		fsCreditBean.obtain(map);
	}
	System.out.println("fsGlobal="+fsGlobal);
	System.out.println("fsCreditBean="+fsCreditBean);
