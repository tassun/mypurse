...
public void fetchResult(java.sql.ResultSet rs) throws java.sql.SQLException {
	...
	if(getBirthday()!=null) {
		java.util.Calendar calendar = butil.getCalendar(getBirthday());
		setBirthyear(calendar.get(java.util.Calendar.YEAR));
		setBirthmonth(calendar.get(java.util.Calendar.MONTH));
		setBirthdate(calendar.get(java.util.Calendar.DAY_OF_MONTH));	
	}
