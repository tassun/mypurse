...
<% 
	...
	String fs_pid = com.fs.bean.util.PageUtility.getParameter(request,"pid"); 
	if(fs_pid==null || fs_pid.trim().length()<=0) {
		RequestDispatcher rd = application.getRequestDispatcher("/index.jsp");
		rd.forward(request, response);
		return;
	}
	String fs_pager = fs_pid+"/"+fs_pid+".jsp";
%>
