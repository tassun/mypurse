	...
	<form id="page_item_form" role="form" data-toggle="validator" name="page_item_form" method="post" action="page_item_de_c.jsp">
		...
		<div class="modal-content portal-area" style="margin-left:15px; padding-top: 10px; padding-left: 5px; padding-bottom:15px;">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="modalheader">New Item List</h4>
			</div>
			<div class="row row-heighter center-block">
				<div class="col-md-9 col-height">
					<div class="input-group">
						...
						<div class="col-md-2">
							<div class="radio">
								<input type="radio" style="margin-left:5px;" class="input-md my-radio" id="cdtypereceive" name="cdtype" checked="true" placeholder="${fsLabel.getText('cdtypereceive','Receive')}" title="Receive" value="1" ${fsScreen.getChecked(fsTRXPBean.cdtype,'1')}/>
						...
						<div class="col-md-2">
							<div class="radio">
								<input type="radio" style="margin-left: 5px;" class="input-md my-radio" id="cdtypepayment" name="cdtype" placeholder="${fsLabel.getText('cdtypepayment','Payment')}" title="Payment" value="0" ${fsScreen.getChecked(fsTRXPBean.cdtype,'0')}/>
			...
			<div class="row row-heighter center-block">
				<div class="col-md-9 col-height form-group" id="cdname_layer">
					<div class="input-group">
						...
						<input type="text" class="form-control input-md my-input" id="cdname" name="cdname" maxlength="80" placeholder="${fsLabel.getText('cdname_placeholder','Title')}" value="${fsTRXPBean.cdname}"/>
					</div>				
					<span id="cdname_alert" role="alert" class="has-error" style="display:none;">${fsLabel.getText('cdname_alert','You can not leave this empty')}</span>
				</div>
			</div>
			<div class="row row-heighter center-block">
				<div class="col-md-6 col-height form-group" id="amt_layer">
					<div class="input-group">
						...
						<input type="number" class="form-control input-md my-input decimal-input" id="amt" name="amt" maxlength="15" placeholder="${fsLabel.getText('amt_placeholder','Estimate Amount')}" value="${fsTRXPBean.amt}"/>
					</div>		
			...
			<div class="row center-block" style="padding-top:0px;">
					<label id="amt_error" class="control-label has-error" style="padding-left:15px; display:none;">${fsLabel.getText('amt_error','Invalid input value')}</label>
			</div>
